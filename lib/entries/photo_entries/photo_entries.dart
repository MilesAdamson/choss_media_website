...
List<PhotoEntry> photoEntries = [
  ...
  PhotoEntry(
    ...
    flavourText: "The core pitch of the new route, being hard at the bottom and scary at the top.",
  ...
  PhotoEntry(
    takenBy: 'Miles Adamson',
    title: "-10 in March",
    flavourText: "Morgan says -10 degrees C is too cold to climb (but just warm enough to belay me).",
  ...
  PhotoEntry(
    ...
    flavourText: "Matt crushed out this amazing Kelowna boulder, which stood unrepeated for years.",
  ...
  PhotoEntry(
    ...
    flavourText: "If you like falling on angular pieces of granite you've come to the right highball.",
    assetPath: "/assets/photos/miles_animal_mag",
  ),
  PhotoEntry(
    takenBy: 'Unknown',
    title: "The Derek Zoolander Highball",
    flavourText: "...for kids who can't climb good and want to learn to do other stuff good too. V7",
